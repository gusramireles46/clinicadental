            ...
            <div class="col-lg-8 col-md-12">
                <div class="input-group mb-3">
                    ...
                    <div class="form-floating">
                        <input required type="text" class="form-control" id="servicio" placeholder="Categoria"
                               name="servicio"
                ...
                <div class="input-group mb-3">
                    ...
                    <?php if ($action == 'EDIT') : ?>
                        ...
                        <div class="mb-3">
                            <img class="img-thumbnail" src="../assets/images/servicios/<?php echo $datos['imagen']; ?>" alt="Imagen de <?php echo $datos['servicio']; ?>">
                        </div>
                    <?php endif; ?>
                <div class="input-group mb-3">
